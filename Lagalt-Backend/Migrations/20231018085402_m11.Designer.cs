            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.MessageModels.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Subject = "Need link",
                            Timestamp = new DateTime(2023, 10, 18, 10, 54, 1, 741, DateTimeKind.Local).AddTicks(412),
                        ...
                        new
                        {
                            ...
                            ProjectId = 1,
                            Subject = "How to do...",
                            Timestamp = new DateTime(2023, 10, 18, 10, 54, 1, 741, DateTimeKind.Local).AddTicks(436),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectRequestId = 1,
                            ProjectId = 2,
                            RequestDate = new DateTime(2023, 10, 18, 10, 54, 1, 740, DateTimeKind.Local).AddTicks(2237),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.Update", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2023, 10, 18, 10, 54, 1, 733, DateTimeKind.Local).AddTicks(9174),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
