...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.MessageModels.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Subject = "Need link",
                            Timestamp = new DateTime(2023, 10, 24, 10, 22, 28, 339, DateTimeKind.Local).AddTicks(1618),
                        ...
                        new
                        {
                            ...
                            ProjectId = 1,
                            Subject = "How to do...",
                            Timestamp = new DateTime(2023, 10, 24, 10, 22, 28, 339, DateTimeKind.Local).AddTicks(1636),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.MilestoneStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MilestoneStatusId = 1,
                            MilestoneStatusName = "Not Started"
                        },
                        new
                        {
                            MilestoneStatusId = 2,
                        ...
                        {
                            MilestoneStatusId = 5,
                            MilestoneStatusName = "Cancelled"
                        },
                        new
                        {
                            MilestoneStatusId = 6,
                            MilestoneStatusName = "Delayed"
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectRequestId = 1,
                            ProjectId = 2,
                            RequestDate = new DateTime(2023, 10, 24, 10, 22, 28, 338, DateTimeKind.Local).AddTicks(7524),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });

            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectRequirement", b =>
                {
                    b.Property<int?>("ProjectId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectRequirement", (string)null);
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectTag", b =>
                {
                    b.Property<int?>("ProjectId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.Resource", b =>
                {
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.Update", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Timestamp = new DateTime(2023, 10, 24, 10, 22, 28, 337, DateTimeKind.Local).AddTicks(4928),
                            UserId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AnonymousModeOn = false,
                            Description = "Love photos",
                            Education = "Photo Academy",
                            UserName = "UserNr2"
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectRequirement", b =>
                {
                    ...
                    b.HasOne("Lagalt_Backend.Data.Models.ProjectModels.Requirement", "Requirements")
                        .WithMany()
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectTag", b =>
                {
                    ...
                    b.HasOne("Lagalt_Backend.Data.Models.ProjectModels.Tag", "Tags")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
