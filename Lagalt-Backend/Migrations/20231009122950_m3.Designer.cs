            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.MessageModels.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatorType = "User",
                            MessageId = 1,
                            Timestamp = new DateTime(2023, 10, 9, 14, 29, 50, 477, DateTimeKind.Local).AddTicks(9794)
                        },
                        new
                        {
                            CommentId = 2,
                            ...
                            CreatorType = "Owner",
                            MessageId = 2,
                            Timestamp = new DateTime(2023, 10, 9, 14, 29, 50, 477, DateTimeKind.Local).AddTicks(9815)
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.MessageModels.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Subject = "Need link",
                            Timestamp = new DateTime(2023, 10, 9, 14, 29, 50, 475, DateTimeKind.Local).AddTicks(8076)
                        },
                        new
                        {
                            MessageId = 2,
                            ...
                            ProjectId = 1,
                            Subject = "How to do...",
                            Timestamp = new DateTime(2023, 10, 9, 14, 29, 50, 475, DateTimeKind.Local).AddTicks(8104)
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.ProjectRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectRequestId = 1,
                            ProjectId = 2,
                            RequestDate = new DateTime(2023, 10, 9, 14, 29, 50, 473, DateTimeKind.Local).AddTicks(7033),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("Lagalt_Backend.Data.Models.ProjectModels.Update", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2023, 10, 9, 14, 29, 50, 471, DateTimeKind.Local).AddTicks(7246),
                            UserId = 1
                        });
                });
